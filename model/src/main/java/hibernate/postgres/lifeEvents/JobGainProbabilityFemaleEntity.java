...
/**
 * Female job gain probabilities.
 */
@javax.persistence.Table(name = "job_gain_probability_female", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class JobGainProbabilityFemaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        JobGainProbabilityFemaleEntity that = (JobGainProbabilityFemaleEntity) o;
