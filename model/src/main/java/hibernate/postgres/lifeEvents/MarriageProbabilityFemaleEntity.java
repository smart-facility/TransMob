...
/**
 * Female marriage probabilities.
 */
@javax.persistence.Table(name = "marriage_probability_female", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MarriageProbabilityFemaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        MarriageProbabilityFemaleEntity that = (MarriageProbabilityFemaleEntity) o;
