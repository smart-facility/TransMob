...
/**
 * Male divorce probabilities.
 */
@javax.persistence.Table(name = "divorce_probability_male", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class DivorceProbabilityMaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        DivorceProbabilityMaleEntity that = (DivorceProbabilityMaleEntity) o;
