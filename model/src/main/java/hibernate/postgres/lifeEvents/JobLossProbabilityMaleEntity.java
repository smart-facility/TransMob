...
/**
 * Male job loss probabilities.
 */
@javax.persistence.Table(name = "job_loss_probability_male", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class JobLossProbabilityMaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        JobLossProbabilityMaleEntity that = (JobLossProbabilityMaleEntity) o;
