...
/**
 * Male death probabilities.
 */
@javax.persistence.Table(name = "death_probability_male", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class DeathProbabilityMaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        DeathProbabilityMaleEntity that = (DeathProbabilityMaleEntity) o;
