...
/**
 * Male job gain probabilities.
 */
@javax.persistence.Table(name = "job_gain_probability_male", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class JobGainProbabilityMaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        JobGainProbabilityMaleEntity that = (JobGainProbabilityMaleEntity) o;
