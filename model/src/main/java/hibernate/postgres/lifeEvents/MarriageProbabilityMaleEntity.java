...
/**
 * Male marriage probabilities.
 */
@javax.persistence.Table(name = "marriage_probability_male", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MarriageProbabilityMaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        MarriageProbabilityMaleEntity that = (MarriageProbabilityMaleEntity) o;
