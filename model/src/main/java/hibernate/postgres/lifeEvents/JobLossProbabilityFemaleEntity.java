...
/**
 * Female job loss probabilities.
 */
@javax.persistence.Table(name = "job_loss_probability_female", schema = "life_event")
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class JobLossProbabilityFemaleEntity {
    private int age;
    ...
    public boolean equals(Object o) {
        ...
        JobLossProbabilityFemaleEntity that = (JobLossProbabilityFemaleEntity) o;
